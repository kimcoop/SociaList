...
public class SociaListActivity extends ListActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {    	
        ...
        lists = getLists();
        ArrayAdapter<CustomList> adapter = new CustomListAdapter(this, R.layout.list_row, lists);
    ...
    protected void onListItemClick(ListView l, View v, int position, long id) {
        ...
        //intent.putExtra("Item", item); // can pass as object because it implements Parcelable - TODO
