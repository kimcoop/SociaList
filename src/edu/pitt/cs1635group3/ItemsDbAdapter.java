...
public class ItemsDbAdapter {
	...
	private static final String LIST_CREATE =
		"create table list (id integer primary key autoincrement, "
		+ "name text not null, originator_id integer not null, "
		+ "creation_date date not null)";
		
	private static final String MAP_ITEM_LIST_CREATE = 
		"create table map_item_list (id integer primary key autoincrement, "
		+ "item_id integer not null, list_id integer not null)";
		
	private static final String MAP_LIST_USER_CREATE = 
		"create table map_list_user (id integer primary key autoincrement, "
    ...
    //private static final String DATABASE_TABLE = "notes"; //USED IN COMMENTED OUT METHODS
	...
	/**
		The following are methods from the original file.
		These are left in to show examples on how to
		manipulate data in the tables. -Rob
